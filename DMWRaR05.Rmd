...
ds <- with(crs$dataset[crs$train, ], 
           rbind(data.frame(dat = Humidity3pm, grp = "All"),
           data.frame(dat = Humidity3pm[RainTomorrow == "No" ], grp = "No" ),
...
r01 <- c("audit         ", "dataset ", "Used to illustrate Benford’s law.     ")
r02 <- c("basicStats()  ", "command ", "Detailed statistics of data.          ")
r03 <- c("bpplot()      ", "command ", "Box-percentile plot.                  ")
r04 <- c("describe()    ", "command ", "Detailed data summary.                ")
r05 <- c("cor()         ", "function", "Correlation between variables.        ")
r06 <- c("Ecdf()        ", "command ", "Produce cumulative distribution plot. ")
r07 <- c("fBasics       ", "package ", "More comprehensive basic statistics.  ")
r08 <- c("hclust()      ", "function", "A hierarchical clustering algorithm.  ") 
r09 <- c("Hmisc         ", "package ", "Additional basic statistics and plots.")
r10 <- c("kurtosis()    ", "function", "A measure of distribution peakiness.  ")
r11 <- c("md.pattern()  ", "command ", "Table of patterns of missing values.  ")
r12 <- c("mice          ", "package ", "Missing data analysis.                ")
r13 <- c("pairs()       ", "command ", "Matrix of pairwise scatter plots.     ") 
r14 <- c("panel.hist()  ", "command ", "Draw histograms within a pairs plot.  ") 
r15 <- c("panel.cor()   ", "command ", "Correlations within a pairs plot.     ")
r16 <- c("panel.smooth()", "command ", "Add smooth line to pairs plot.        ")
r17 <- c("sample()      ", "function", "Select a random sample of a dataset.  ")
r18 <- c("skewness()    ", "function", "A measure of distribution skew.       ")
r19 <- c("summary()     ", "command ", "Basic dataset statistics.             ")
r20 <- c("weather       ", "dataset ", "Sample dataset from rattle.           ")
objTable <- rbind(r01, r02, r03, r04, r05, r06, r07, r08, r09, r10, 
                  r11, r12, r13, r14, r15, r16, r17, r18, r19, r20)
colnames(objTable) <- c("Object", "Type", "Description")
rownames(objTable) <- c(1:29)
